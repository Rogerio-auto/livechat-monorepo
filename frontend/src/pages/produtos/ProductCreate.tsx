        ...
        <div className="space-y-8">
          ...
          <div className="mb-10">
            <div className="flex items-center gap-2 text-sm text-(--color-text-muted) mb-2">
              ...
              <span>/</span>
              <span className="text-(--color-text) font-medium">Novo {config.labels.itemName}</span>
            </div>
            <h1 className="text-3xl font-bold text-(--color-text)">Novo {config.labels.itemName}</h1>
            <p className="mt-2 text-(--color-text-muted)">Preencha os campos abaixo para cadastrar um novo item no catálogo.</p>
          </div>
