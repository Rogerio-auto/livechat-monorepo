          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                onClick={addColumn}
                disabled={isLoading}
                className="flex items-center gap-1 px-3 py-1 text-sm bg-blue-500 text-white rounded-lg
            ...
            <div className="space-y-3">
              {columns.map((col, idx) => (
                ...
                >
                  {/* Posição */}
                  <div className="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-gray-200 dark:bg-gray-600 rounded-full text-sm font-bold text-gray-700 dark:text-gray-300">
                    {idx + 1}
                  </div>
                          ...
                          {PRESET_COLORS.map(color => (
                            <button
                              ...
                              style={{
                                ...
                                borderColor: col.color === color ? "#000" : "#ccc"
                              }}
                            />
                          ))}
                        </div>
                  ...
                  <button
                    ...
                    className="w-8 h-8 flex items-center justify-center text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 
