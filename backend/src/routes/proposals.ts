  ...
  app.post("/proposals", requireAuth, async (req: any, res) => {
    try {
      ...
      const insert: any = {
        ...
        // Campos solares (calculados automaticamente pelo frontend)
        ...
        solar_monthly_production: body.solar_monthly_production ?? null,
        solar_monthly_consumption: body.solar_monthly_consumption ?? null,
        solar_annual_production: body.solar_annual_production ?? null,
        solar_annual_consumption: body.solar_annual_consumption ?? null,
        solar_current_bill_value: body.solar_current_bill_value ?? null,
        solar_future_bill_value: body.solar_future_bill_value ?? null,
        solar_savings_value: body.solar_savings_value ?? null,
        solar_payback_years: body.solar_payback_years ?? null,
        solar_payback_months: body.solar_payback_months ?? null,
        solar_panel_warranty: body.solar_panel_warranty ?? null,
        solar_inverter_warranty: body.solar_inverter_warranty ?? null,
        solar_structure_warranty: body.solar_structure_warranty ?? null,
        solar_service_warranty: body.solar_service_warranty ?? null,
        solar_energy_tariff: body.solar_energy_tariff ?? null,
        solar_co2_1year: body.solar_co2_1year ?? null,
        solar_co2_25years: body.solar_co2_25years ?? null,
        solar_co2_trees: body.solar_co2_trees ?? null,
      };
