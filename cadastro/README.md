# Frontend de Cadastro - Porta 3002

## 🚀 Sistema de Cadastro

Frontend dedicado para o fluxo de registro e cadastro de novos usuários.
...
│   ├── hooks/
│   │   ├── useCadastro.ts         # Hook de configuração
│   │   └── useSignup.ts           # Hook de signup
│   ├── types/
│   │   └── cadastro.ts            # Tipos TypeScript
│   ├── App.tsx
│   ├── main.tsx
│   └── index.css
├── index.html
...
Configure DNS para: `registro.seudominio.com.br` ou `cadastro.seudominio.com.br`
