...
export function CompanyStep({ onNext, onBack }: CompanyStepProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Criar empresa no backend (já autenticado do passo anterior)
      const API_BASE = import.meta.env.VITE_API_URL || "";
      const res = await fetch(`${API_BASE}/api/onboarding/create-company`, {
        method: "POST",
      ...
      // Empresa criada com sucesso! Avançar para onboarding
      onNext(data);
    } catch (err: any) {
