...
export default function TemplateCard({ template, canManage, onEdit, onClone, onDelete, onView, onSubmitToMeta }: TemplateCardProps) {
  ...
  return (
    <Card 
      ...
      hover
      padding="none"
      className="shrink-0 w-72 overflow-hidden border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/50 group hover:shadow-xl  transition-all duration-300 hover:border-gray-300 dark:hover:border-gray-600"
    >
