          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-2">
            <div>
              <div className="flex items-center gap-2 text-xs font-semibold text-slate-500 uppercase tracking-widest mb-3">
                ...
                <span>/</span>
                <span className="text-slate-900 dark:text-white">Editar {config.labels.itemName}</span>
              </div>
              <h1 className="text-2xl font-bold text-slate-900 dark:text-white tracking-tight sm:text-3xl">
                Editar {config.labels.itemName}
              </h1>
              <p className="mt-2 text-slate-500 text-sm">Altere as informações do item abaixo e salve para atualizar o catálogo.</p>
            </div>
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="flex flex-wrap gap-4">
                      ...
                      {(form.images || []).length < 10 && (
                        <div 
                          className="w-24 h-24 rounded-2xl border-2 border-dashed border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center bg-white dark:bg-slate-900 hover:border-(--color-primary) transition-all cursor-pointer group shadow-sm"
