...
export function TopBar({ onMenuClick }: TopBarProps) {
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-[color:var(--color-border)] bg-[color:var(--color-bg)]/90 backdrop-blur-xl">
      <div className="flex items-center gap-3 px-4 py-3 sm:px-6 lg:px-10">
        <button
          type="button"
          onClick={onMenuClick}
          className="flex h-11 w-11 items-center justify-center rounded-2xl border border-[color:var(--color-border)] text-xl text-[color:var(--color-heading)] shadow-sm hover:bg-[color:var(--color-surface-muted)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-highlight)] lg:hidden"
        ...
        <div className="flex flex-col">
          ...
          <span className="text-lg font-semibold text-[color:var(--color-heading)]">
            {meta.title}
          </span>
        </div>
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-3">
          ...
          <button
            type="button"
            onClick={toggleTheme}
            className="flex h-11 w-11 items-center justify-center rounded-2xl border border-[color:var(--color-border)] text-lg text-[color:var(--color-heading)] shadow-sm hover:bg-[color:var(--color-surface-muted)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[color:var(--color-highlight)]"
